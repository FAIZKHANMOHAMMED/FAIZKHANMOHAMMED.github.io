...
function setTrack(stream, audioElement, participant, isLocal) {
  if (stream.kind == "video") {
    ...
    videoElm.classList.add("flipped-video"); // Add class to flip video
    videoElm
      .play()
      .catch((error) =>
    ...
    // In PiP mode, find the PiP video element and apply the same transformation
    if (document.pictureInPictureElement === videoElm) {
      videoElm.classList.add("flipped-video-pip");
    }
  }
